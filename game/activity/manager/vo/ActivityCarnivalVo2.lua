...
module('game.activity.manager.vo.ActivityCarnivalVo2', Class.impl())
...
function getIsCanRec(self)
    return (activity.ActitvityExtraManager:getIsOpenByDay2(self.id) and not self:getIsRecived())
end

function getIsRecived(self)
    return activity.ActitvityExtraManager:getIsRecivedByDay2(self.id)
end
