...
function setData(self, param)
    ...
    if self.data then
        ...
        local nowGetNum = noviceActivity.NoviceActivityManager.heroRecruitedTimes > max and max or
                              noviceActivity.NoviceActivityManager.heroRecruitedTimes
