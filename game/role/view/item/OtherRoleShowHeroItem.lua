...
module('game.role.view.OtherRoleShowHeroItem', Class.impl("lib.component.BaseContainer"))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("role/item/OtherRoleShowHeroItem.prefab")
