-- @FileName:   RankingTeachingView.lua
-- @Description:   描述
-- @Author: ZDH
-- @Date:   2025-01-15 14:47:25
-- @Copyright:   (LY) 2024 锚点降临

module('game.ranking.view.RankingTeachingView', Class.impl(View))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("ranking/RankingTeachingView.prefab")
...
function active(self, args)
    ...
    self.resList = {"ranking_bg_05.jpg"}
    self.des = {151188}
...
function updateView(self)
    ...
    for i, resName in ipairs(self.resList) do
        ...
        item:getChildGO("mImgInfo"):GetComponent(ty.AutoRefImage):SetImg(UrlManager:getBgPath(string.format("ranking/%s", resName)), false)
