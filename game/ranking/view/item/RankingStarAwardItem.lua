-- @FileName:   RankingStarAwardItem.lua
-- @Description:   描述
-- @Author: ZDH
-- @Date:   2024-12-03 17:26:02
-- @Copyright:   (LY) 2024 锚点降临
module('game.ranking.view.RankingStarAwardItem', Class.impl('lib.component.BaseItemRender'))
...
function onGetAward(self)
    GameDispatcher:dispatchEvent(EventName.ONREQ_RANKING_GET_AWARD, {self.data.config.id})
end
