-- @FileName:   PickGoldTeachingView.lua
-- @Description:   描述
-- @Author: ZDH
-- @Date:   2025-01-15 14:47:25
-- @Copyright:   (LY) 2024 锚点降临

module('game.pickGold.view.PickGoldTeachingView', Class.impl(View))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("pickGold/PickGoldTeachingView.prefab")
...
function active(self, args)
    ...
    self.resList = {"pickGold_teaching.png"}
    self.des = {151249}
...
function updateView(self)
    ...
    for i, resName in ipairs(self.resList) do
        ...
        item:getChildGO("mImgInfo"):GetComponent(ty.AutoRefImage):SetImg(UrlManager:getBgPath(string.format("pickGold/%s", resName)), false)
