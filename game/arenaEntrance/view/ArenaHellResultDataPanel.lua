...
function initViewText(self)
    for i = 1, #self.mRoundList do
        self.mRoundList[i].transform:Find("mTxtRound"):GetComponent(ty.Text).text = _TT(62263) .. i
        self.mRoundList[i].transform:Find("mIsSelect/mTxtSelectRound"):GetComponent(ty.Text).text = _TT(62263) .. i
    end
