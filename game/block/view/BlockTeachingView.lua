-- @FileName:   BlockTeachingView.lua
-- @Description:   描述
-- @Author: ZDH
-- @Date:   2025-01-15 14:47:25
-- @Copyright:   (LY) 2024 锚点降临

module('game.block.view.BlockTeachingView', Class.impl(View))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("block/BlockTeachingView.prefab")
...
function updateView(self)
    ...
    for i, resName in ipairs(self.resList) do
        ...
        item:getChildGO("mImgInfo"):GetComponent(ty.AutoRefImage):SetImg(UrlManager:getBgPath(string.format("block/%s", resName)), false)
