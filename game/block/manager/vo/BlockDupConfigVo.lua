-- @FileName:   BlockDupConfigVo.lua
-- @Description:   文件描述
-- @Author: ZDH
-- @Date:   2023-07-25 11:52:14
-- @Copyright:   (LY) 2023 雷焰网络

module('game.block.manager.vo.BlockDupConfigVo', Class.impl())
...
function parseCogfigData(self, key, cusData)
    ...
    self.begin_list = cusData.begin_list
    self.pre_id = cusData.pre_id
    self.target_score = cusData.target_score
    self.remove_score = cusData.remove_score
