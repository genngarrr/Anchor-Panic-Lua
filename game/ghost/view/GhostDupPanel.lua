...
module('ghost.GhostDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("ghost/GhostDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = ghost.GhostManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onFight(self)
    local activity_id = activity.ActivityId.Ghost
