...
function initViewText(self)
    ...
    self:setBtnLabel(self.mBtnFight, 78589)
    self:setBtnLabel(self.mBtnFormation, 62254)
    self:setTextLabel("mTextMyTeam", 47701)
    self:setTextLabel("mTextEmyTeam", 62245)
    self:setTextLabel("mTextSkip", 62255)
end
