--[[ 
-----------------------------------------------------
@filename       : FormationArenaPeakDefenseController
...
module("formation.FormationArenaPeakDefenseController", Class.impl("game/formation/arenaPeakAttack/controller/FormationArenaPeakAttackController"))

---------------------------------------------------------------固定需要-----------------------------------------------------------------
function getManager(self)
    return formation.FormationArenaPeakDefenseManager
end
...
function __openFormationPanel(self)
    if self.m_heroFormationPanel == nil then
        self.m_heroFormationPanel = formation.FormationArenaPeakDefensePanel.new()
...
function __onOpenFormationHeroSelectPanelHandler(self, args)
    if self.mFormationHeroSelectPanel == nil then
        self.mFormationHeroSelectPanel = formation.FormationArenaPeakDefenseSelectPanel.new()
