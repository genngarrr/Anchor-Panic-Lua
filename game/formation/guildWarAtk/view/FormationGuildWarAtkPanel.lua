--[[ 
-----------------------------------------------------
@filename       : FormationGuildWarAtkPanel
...
module("formation.FormationGuildWarAtkPanel", Class.impl(formation.FormationPanel))

UIRes = UrlManager:getUIPrefabPath("formation/FormationGuildWarPanel.prefab")
...
function configUI(self)
    ...
    self.mBtnTeam_3:SetActive(false)
...
function initViewText(self)
    ...
    self:setTextLabel("mTxtTeamName1", nil, _TT(149161) .. 1)
    self:setTextLabel("mTxtTeamName2", nil, _TT(149161) .. 2)
    self:setTextLabel("mTxtDrag", 62266)
end
