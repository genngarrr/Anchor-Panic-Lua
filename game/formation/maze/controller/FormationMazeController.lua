--[[ 
-----------------------------------------------------
@filename       : FormationMazeController
@Description    : 迷宫·副本备战
...
module("formation.FormationMazeController", Class.impl("game.formation.normal.controller.FormationController"))

---------------------------------------------------------------固定需要-----------------------------------------------------------------
function getManager(self)
    return formation.FormationMazeManager
end
...
function __openFormationPanel(self)
    if self.m_heroFormationPanel == nil then
        self.m_heroFormationPanel = formation.FormationMazePanel.new()
...
function __onOpenFormationHeroSelectPanelHandler(self, args)
    if self.mFormationHeroSelectPanel == nil then
        self.mFormationHeroSelectPanel = formation.FormationMazeHeroSelectPanel.new()
